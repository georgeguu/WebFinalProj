...
$(document).ready(function(){
	...
	//change to onclick function listAllBooks(k) below
        ...
        $.each(books, function(i, book){
            if(i%8 == 0){
                ...
                if(i >= minBook && i <= maxBook){
                    $('#pageBtn').append('<a href="#" class="btn btn-danger pull-left" type="button" onclick="listAllBooks('+ pageNum +'); return false;">'+ pageNum +'</a>')
                }else{
                    $('#pageBtn').append('<a href="#" class="btn btn-light pull-left" type="button" onclick="listAllBooks('+ pageNum +'); return false;">'+ pageNum +'</a>')    
                }
                
            }
            if(i >= minBook && i <= maxBook){
                var pageNum = parseInt(i/8 +1);
                $('#MyContent').append('<div class="col-sm-6 col-md-3"><div class="thumbnail"><a href="#" onclick="showInfo(\''+book.Title +'\','+ pageNum +')"><img src="../images/'+ book.Title +'.jpg" class="pic"></a><div class="caption"><h5>'+book.Title+'</h5><div class="clearfix"><div class="price pull-left">$'+book.Price+'</div><a href="#" class="btn btn-success pull-right" type="button" onclick="addToCart(\''+book.Title +'\'); return false;">add to cart</a></div></div></div></div>');   
            }                    
